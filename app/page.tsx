...
export default function Home() {
  ...
  const loadingSequence = [
    { id: 'computer-icon', delay: 100 },
    { id: 'projects-icon', delay: 200 },
    { id: 'internet-explorer-icon', delay: 300 },
    { id: 'recycle-icon', delay: 400 },
    { id: 'taskbar', delay: 500 },
    { id: 'browser-window', delay: 600 },
    { id: 'cursor', delay: 700 }
  ]
